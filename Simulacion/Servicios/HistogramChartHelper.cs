...
namespace Simulacion.Servicios
{
    public class HistogramChartHelper
    {
        ...
        public void CreateHistogram(
            ...
            List<Intervalo> ListaIntervalos)
        {
            // Validate input
            ...
            if (chartControl.Series.IndexOf(histogramSeriesName) < 0)
            {
                ...
                histogramSeries.Color = Color.RoyalBlue;
                histogramSeries.BackSecondaryColor = Color.SkyBlue;
                histogramSeries.BackGradientStyle = GradientStyle.VerticalCenter;
                histogramSeries.LegendText = "Cantidad de números";
                histogramSeries.LegendToolTip = "Intervalos";
            }
            else
            {
            ...
            //NO SE REDONDEAN LOS VALORES MINIMO Y MAXIMO
            ...
            for (currentPosition = minValue; currentPosition <= maxValue; currentPosition += this.SegmentIntervalWidth)
            {
                ...
                //cargo cada intervalo con sus limites y cantidad de observaciones
                ListaIntervalos.Add(new Intervalo(currentPosition, currentPosition + this.SegmentIntervalWidth / 2.0, count));
            }
            ...
            chartArea.AxisY.Title = "Cantidad de números";
            ...
            // ' SE LO COMENTA PARA QUE PUEDA MOSTRAR MAS DE 10 ETIQUETAS EN EL EJE X
